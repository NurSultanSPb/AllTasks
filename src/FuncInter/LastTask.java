...
public class LastTask {
    public static void main(String[] args) {
        // Random variables
        String randomFrom = "Bank"; // Некоторая случайная строка. Можете выбрать ее самостоятельно.
        String randomTo = "MYwallet";  // Некоторая случайная строка. Можете выбрать ее самостоятельно.
 ...
 */
    public static abstract class Super <T> {
        private String from, to;
        private T content;
        public Super(String from, String to, T content) {
            this.from = from;
            this.to = to;
            this.content = content;
        }
    ...
    public static class MailMessage extends Super <String>{
        public MailMessage(String from, String to, String content) {
            super(from, to, content);
        }
    }

    public static class Salary extends Super <Integer>{
        public Salary(String from, String to, Integer content) {
            super(from, to, content);
        }
    }

    public static class MailService<T> implements Consumer<Super<T>> {
        ...
        @Override
        public void accept(Super<T> sendable) {
